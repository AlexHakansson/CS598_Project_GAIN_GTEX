...
if __name__ == '__main__':
    ...
    model.save(
    '{}/checkpoints/{}_inplace{}_{}_train.keras'.format(config.save_dir, config.model, config.inplace_mode, config.pathway))
    #generator.save(
    #'{}/checkpoints/{}_inplace{}_{}_gen_train.keras'.format(config.save_dir, config.model, config.inplace_mode, config.pathway))
    #pickle.dump(model,open("test_model413_train.pkl","wb"))
    pickle.dump(generator,open("results/checkpoints/test_generator_train.pkl","wb"))